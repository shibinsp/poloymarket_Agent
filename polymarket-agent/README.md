...
**`static/index.html` is a build artifact — do not edit it.** The dashboard source lives in [`ui/`](ui/README.md) (React + TypeScript, built by Vite into that one self-contained file). After changing it:
